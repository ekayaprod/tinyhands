...
const SHELL = [
  ...
  '/js/games/balloon-float/constants.js',
  '/js/games/balloon-float/index.js',
  '/js/games/rocket-ride/constants.js',
  '/js/games/rocket-ride/index.js',
  '/js/games/ball-bonanza.js',
  '/js/games/tiny-town/constants.js',
  '/js/games/tiny-town/index.js',
